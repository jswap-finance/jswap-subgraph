...
import { Bundle, Pair, PairDayData, Token, TokenDayData, TokenHourData, JswapDayData, JswapFactory } from '../types/schema'
import { PairHourData } from './../types/schema'
import { FACTORY_ADDRESS, ONE_BI, ZERO_BD, ZERO_BI } from './helpers'

export function updateJswapDayData(event: EthereumEvent): JswapDayData {
  let uniswap = JswapFactory.load(FACTORY_ADDRESS)
